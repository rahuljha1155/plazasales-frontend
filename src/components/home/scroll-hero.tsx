        ...
        <div className="space-y-2 sm:space-y-8 relative z-40 flex flex-col items-center text-center lg:text-left lg:items-start justify-center">
          <div className="text-sm sm:text-base lg:text-lg text-center lg:text-left text-white">
            ...
            <span className="text-white font-medium">
              the full spectrum of it and electronics
            </span>
          </div>
          <h1 className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl text-center lg:text-left font-semibold leading-tight text-white">
          ...
          <div className="flex justify-center lg:justify-start gap-3 sm:gap-6 w-full mt-4 lg:mt-0 divide-x divide-zinc-300 dark:divide-zinc-700 md:pt-4">
            <div className="flex flex-col sm:flex-row gap-1 sm:gap-2 items-center sm:items-center sm:pr-4">
              ...
              <p className="text-[10px] sm:text-xs text-center text-white sm:text-left text-muted-foreground max-w-[80px] leading-tight">
                Years of Experience
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-1 sm:gap-2 items-center sm:items-center sm:pl-4">
              ...
              <p className="text-[10px] sm:text-xs text-center sm:text-left text-muted-foreground text-white max-w-[80px] leading-tight">
                Product SKU Range
              </p>
            </div>
          </div>
