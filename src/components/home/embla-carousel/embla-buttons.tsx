...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      type="button"
      disabled={disabled}
      className={`flex items-center justify-center w-10 h-10 rounded-xs  text-white/80 
      transition-all duration-200 hover:scale-105 hover:text-white hover:border-black
      active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed`}
      {...restProps}
    >
      <svg className="size-4 md:size-8" viewBox="0 0 532 532" fill="currentColor">
