...
import { DotButton, useDotButton } from "../home/embla-carousel/embla-dots";
import { NextButton, PrevButton, usePrevNextButtons } from "../home/embla-carousel/embla-buttons";
...
const ProductSlider: React.FC<PropType> = ({ slides, options }) => {
  ...
  return (
    <div className="embla h-90 overflow-hidden mx-auto ">
      ...
      <div className="overflow-hidden  relative" ref={emblaRef}>
          ...
          {slides.map((data, index) => (
            ...
            >
              <div className=" pb-4   overflow-hidden">
                ...
                <div className="embla__parallax__layer  h-90 relative  flex justify-center">
                  <Image
                    src={data}
                    alt="Slide image"
                    height={1000}
        ...
        <div className="absolute inset-0 pointer-events-none h-90 flex justify-between items-center">
        ...
        <div className="absolute inset-0 flex justify-center items-end pb-4 h-90  pointer-events-none">
