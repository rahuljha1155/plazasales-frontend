...
export default function RadialOrbitalTimeline({
  ...
  return (
    ...
    >
      <div className="relative w-full scale-150 max-w-4xl h-full flex items-center justify-center">
        <div
                ...
                {isExpanded && (
                  <Card className="absolute gap-0 bg-primary text-white top-20 left-1/2 -translate-x-1/2 w-96 dark:bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm flex justify-between items-center mt-2">
                        {item.title}
                        <Icon icon={"uiw:close"} className="inline-block ml-2 mb-1" />
                      </CardTitle>
                    </CardHeader>
