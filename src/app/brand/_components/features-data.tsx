...
export const brandFeatures: Feature[] = [
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} className="size-8" viewBox="0 0 24 24">
        <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M18 18.75H6a2.25 2.25 0 0 0 0 4.5h12a2.25 2.25 0 0 0 0-4.5M8.25 4.5a3.75 3.75 0 1 0 7.5 0a3.75 3.75 0 0 0-7.5 0M12 11.25A8.23 8.23 0 0 1 5.944 8.6L9.75 18.75h4.5L18.056 8.6A8.23 8.23 0 0 1 12 11.25"></path>
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} className="size-8" viewBox="0 0 24 24">
        <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.3} d="M17.684 3.603c.521-.659.03-1.603-.836-1.603h-6.716a1.06 1.06 0 0 0-.909.502l-5.082 8.456c-.401.666.103 1.497.908 1.497h3.429l-3.23 8.065c-.467 1.02.795 1.953 1.643 1.215L20 9.331h-6.849z"></path>
      </svg>
    ),
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width={256} height={256} className="size-8" strokeWidth={4} viewBox="0 0 256 256">
        <path fill="currentColor" d="M208 82h-34V56a46 46 0 0 0-92 0v26H48a14 14 0 0 0-14 14v112a14 14 0 0 0 14 14h160a14 14 0 0 0 14-14V96a14 14 0 0 0-14-14M94 56a34 34 0 0 1 68 0v26H94Zm116 152a2 2 0 0 1-2 2H48a2 2 0 0 1-2-2V96a2 2 0 0 1 2-2h160a2 2 0 0 1 2 2Zm-82-94a26 26 0 0 0-6 51.29V184a6 6 0 0 0 12 0v-18.71a26 26 0 0 0-6-51.29m0 40a14 14 0 1 1 14-14a14 14 0 0 1-14 14"></path>
      </svg>
    ),
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width={25} height={24} className="size-8" viewBox="0 0 25 24">
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width={14} height={14} className="size-8" viewBox="0 0 14 14">
        <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={0.8}>
          <path d="M.643.643v12.714h12.714"></path>
          <path d="M4.581 3.854a1.776 1.776 0 1 1 0 3.552a1.776 1.776 0 0 1 0-3.552m7-2.968a1.776 1.776 0 1 1 0 3.551a1.776 1.776 0 0 1 0-3.551m-2.469 6.52a1.776 1.776 0 1 1 0 3.552a1.776 1.776 0 0 1 0-3.552M.643 9.424l2.534-2.706m2.953-.202L7.755 8.03m2.141-.452l1.171-3.219"></path>
        </g>
      </svg>
    ),
